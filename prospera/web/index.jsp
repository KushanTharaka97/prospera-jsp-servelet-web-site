<%-- 
    Document   : index
    Created on : Oct 26, 2019, 1:36:43 PM
    Author     : asus
--%>
...
<html lang="en-US">
  <head>
    ...
    <title>Prospera_Animal Care</title>
  ...
  <body class="size-1140">
  	...
  	<a target="_blank" class="hide-s" href="../template/prospera-premium-responsive-business-template/" style="position:fixed;top:120px;right:0px;z-index:10;"><img src="img/logo-free.png" alt="" style="height:50px;width:180px;"></a>
    <!-- HEADER -->
    <header role="banner">    
      <!-- Top Bar -->
          ...
          <div class="top-nav s-12 l-10">
            ...
            <ul class="right chevron">
              ...
              <li><a href="contact.html">Contact</a></li>
               <li><a href="login.jsp">Register With Us</a></li>
            </ul>
          </div>
        </div>
      </nav>
    ...
    <main role="main">
          ...
          <div class="carousel-fade-transition owl-carousel carousel-main carousel-nav-white carousel-wide-arrows">
            <div class="item">
              <div class="s-12 center">
                <img src="img/first.jpg" style="width:1200px;height:500px;" alt="">
            ...
            <div class="item">
              <div class="s-12 center">
                <img src="img/second.jpg" style="width:1200px;height:500px;" alt="">
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
        ...
        <div class="line">
          <div class="margin">
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom">
                <a href="askQuestions/askcheckup.jsp">
              <img class="margin-bottom" src="img/checkcat.jpg" alt="Check Cat alt" style="height:220px;width:300px;">
              <h2 class="text-thin">Question Abot Checkups</h2>
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom">
                 <a href="askQuestions/askcat.jsp">
              <img class="margin-bottom" src="img/catSur.jpg" alt="cat surgery alt" style="height:220px;width:300px;">
              <h2 class="text-thin">Question about Surgeries</h2>
              <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p> 
              <a class="text-more-info text-primary-hover" href="/">Read more</a>      
                 </a>
            </div>
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom">
                 <a href="askQuestions/askneu.jsp">
              <img class="margin-bottom" src="img/neuter.jpg" alt="neuter cat alt" style="height:220px;width:300px;">
              <h2 class="text-thin"> Dieseas and neutral</h2>
              <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p> 
              <a class="text-more-info text-primary-hover" href="/">Read more</a>        
                 </a>
            </div>
      ...
      <section class="section background-white">
        <div class="full-width text-center">
          ...
          <div class="line">
            <h2 class="headline text-thin text-s-size-30">Health risks <span class="text-primary">that are associated</span>with pets include: </h2>
            <p class="text-size-20 text-s-size-16 text-thin">  
Aggravation of allergies and asthma caused by dander and fur or feathers
Falling injuries. 
Tripping over pets, especially dogs causes more than 86,000 falls serious enough to prompt a trip to the emergency room each year in the United States.Among elderly and disabled people, these falls have resulted in life-threatening injuries and broken bones.
...
Anxiety over who will care for the animal should the owner no longer be able to do so</p>
