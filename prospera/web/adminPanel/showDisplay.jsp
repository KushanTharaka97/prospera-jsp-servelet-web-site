<%-- 
    Document   : showDisplay
    Created on : Oct 20, 2019, 2:53:22 AM
    Author     : asus
--%>
        ...
        <%@page import="java.sql.*" %>
            ...
            <table border="2" align="center" class="container" class="table">
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="../deletePartners">
                            <input type="hidden" name="update" value="<%out.println(rs.getString("email"));%>">
                            <input type="submit" name="submit" value="Remove Clinic" ID="button" >
                        </form>
                    </td>
                </tr>
                </thead>
